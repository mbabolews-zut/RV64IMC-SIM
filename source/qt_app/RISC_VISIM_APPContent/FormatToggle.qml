...
TabBar {
    ...
    TabButton {
        ...
        implicitWidth: 50
        implicitHeight: 28
        onClicked: root.selectedFormat = FormatToggle.Format.Decimal
    ...
    TabButton {
        ...
        implicitWidth: 50
        implicitHeight: 28
        onClicked: root.selectedFormat = FormatToggle.Format.Hex
    ...
    TabButton {
        ...
        implicitWidth: 50
        implicitHeight: 28
        onClicked: root.selectedFormat = FormatToggle.Format.Binary
